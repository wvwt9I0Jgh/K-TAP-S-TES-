            ...
            <div class="border-b border-gray-800 py-2">
                <div class="flex justify-between items-center px-4">
                    ...
                    <div class="flex space-x-4">
                        <a href="üyegiriş.php" class="text-sm hover:text-gray-300">Üye Giriş</a>
                        <a href="kayıt.php" class="text-sm hover:text-gray-300">Kayıt Ol</a>
                    </div>
                </div>
            </div>
...
<div class="container mx-auto p-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            if (!empty($search_results)) {
                foreach ($search_results as $row) {
                    $book_img = $row['kitap_resmi'];
                    $book_title = $row['kitap'];
                    $book_author = $row['yazar'];
                    $book_pages = $row['sayfa_sayisi'];
                    $book_genre = $row['turu'];
                    $book_id = $row['kitap_no'];
            ?>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="/üyeler/imgs/<?php echo $book_img; ?>" class="w-full h-48 object-cover" alt="<?php echo $book_title; ?>">
                <div class="p-4">
                    <h5 class="text-lg font-bold"><?php echo $book_title; ?></h5>
                    <p class="text-gray-700">Yazar: <?php echo $book_author; ?></p>
                    <p class="text-gray-700">Sayfa Sayısı: <?php echo $book_pages; ?></p>
                    <p class="text-gray-700">Tür: <?php echo $book_genre; ?></p>
                    <a href="kitapaçıklaması.php?id=<?php echo $book_id; ?>" class="text-blue-500 hover:underline">Daha Fazla</a>
                </div>
            </div>
            <?php
                }
            } else {
                echo "<p class='text-center text-gray-700'>Kitap bulunamadı.</p>";
            }
            ?>
        </div>
    </div>
    ...
    <div class="relative h-96 overflow-hidden">
        <div class="flex transition-transform duration-500" id="carousel">
            <img src="/üyeler/imgs/indir (21).jpg" class="w-full h-96 object-cover brightness-75" alt="Kitap 1">
            <img src="/üyeler/imgs/indir (22).jpg" class="w-full h-96 object-cover brightness-75" alt="Kitap 2">
            <img src="/üyeler/imgs/indir (23).jpg" class="w-full h-96 object-cover brightness-75" alt="Kitap 3">
            <img src="/üyeler/imgs/indir (24).jpg" class="w-full h-96 object-cover brightness-75" alt="Kitap 4">
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
        <h2 class="text-3xl font-bold text-gray-800 mb-8 text-center">Öne Çıkan Kitaplar</h2>
